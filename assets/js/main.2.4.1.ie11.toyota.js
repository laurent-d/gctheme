 ...
 * Last modified : 2020-02-13 by @opheJansen
 */
...
/* Show If (Condition multiple) */
  ...
  // Sessions search
  if (isIE11) {
    lazyLoadScript("https://applidget.github.io/vx-assets/templates/website/js/legacy/sessions-search.1.0.0.js?v=4", ".sessions-search-form");
  } else {
    lazyLoadScript("https://applidget.github.io/vx-assets/templates/website/js/sessions-search.1.0.0.js?v=4", ".sessions-search-form");
  }
